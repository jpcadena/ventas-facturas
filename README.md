...
<h3 align="center">ventas-facturas</h3>

  <p align="center">
    Description for Ventas facturas
    <br />
    <a href="https://github.com/jpcadena/ventas-facturas"><strong>Explore the docs »</strong></a>
    <br />
  </p>
</div>
...
1. Clone the **repository**
    ```
    git clone https://github.com/jpcadena/ventas-facturas.git
    ```
...
E-mail: [Juan Pablo Cadena Aguilar](mailto:jpcadena@espol.edu.ec?subject=[GitHub]ventas-facturas)
